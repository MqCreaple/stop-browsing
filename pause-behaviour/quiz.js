  ...
  behaviours.quiz = {
    ...
    create: function (cleanUp, params) {
      ...
      function updateProgress() {
        progressFill.style.width = `${(currentIdx / 10) * 100}%`;
        progressText.textContent = `${currentIdx} / 10`;
      }
      ...
      function enterGiveUpMode() {
        giveUpRemaining = 120;
        const pEl = container.querySelector('#quiz-problem');
        ...
        giveUpInterval = setInterval(() => {
          ...
          if (el) el.querySelectorAll('div')[1].textContent = String(giveUpRemaining);
